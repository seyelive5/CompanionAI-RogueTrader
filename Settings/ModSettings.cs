...
namespace CompanionAI_v2_2.Settings
{
    /// <summary>
    /// Language option
    /// </summary>
    ...
    public static class Localization
    {
        ...
        {
            // Header
            ["Title"] = new() { { Language.English, "Companion AI v2.2 - Timing Aware System" }, { Language.Korean, "동료 AI v2.2 - 타이밍 인식 시스템" } },
            ["Subtitle"] = new() { { Language.English, "Complete AI replacement with proper skill timing" }, { Language.Korean, "스킬 타이밍을 고려한 완전한 AI 대체" } },
