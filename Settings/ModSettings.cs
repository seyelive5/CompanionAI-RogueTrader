...
namespace CompanionAI_v2.Settings
{
    /// <summary>
    /// Language option
    /// </summary>
    ...
    public static class Localization
    {
        ...
        {
            // Header
            ["Title"] = new() { { Language.English, "Companion AI v2 - Complete Replacement" }, { Language.Korean, "동료 AI v2 - 완전 대체" } },
            ["Subtitle"] = new() { { Language.English, "Complete AI replacement for your companions" }, { Language.Korean, "동료의 AI를 완전히 대체합니다" } },
            ...
            // Role descriptions - 더 상세하고 알기 쉽게
            ...
            // Range preference descriptions - 더 상세하고 알기 쉽게
        ...
        public static string GetRoleName(AIRole role)
        {
            return Get($"Role_{role}");
        }

        public static string GetRoleDescription(AIRole role)
        {
            return Get($"RoleDesc_{role}");
        }

        public static string GetRangeName(RangePreference pref)
        {
            return Get($"Range_{pref}");
        }

        public static string GetRangeDescription(RangePreference pref)
        {
            return Get($"RangeDesc_{pref}");
        }
    }
    ...
    public enum AIRole
    {
        Balanced,   // Default balanced behavior (상황 적응)
        Tank,       // Prioritize defense, draw enemy attention (방어/어그로)
        DPS,        // Prioritize damage output (공격 최대화)
        Support,    // Prioritize buffs and debuffs (버프/디버프)
        Hybrid,     // Melee + Ranged flexible (근접/원거리 겸용)
        Sniper      // Maximum range, stay back (원거리 유지)
    }
    ...
    public class ModSettings
    {
        ...
        /// <summary>
        /// Get or create settings for a specific character
        /// </summary>
